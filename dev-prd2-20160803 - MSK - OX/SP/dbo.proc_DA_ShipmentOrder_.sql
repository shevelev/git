...
(
	...
	b_city varchar(45),
	b_contact1 varchar(30),
	b_contact2 varchar(30),
	b_company varchar(45),
	c_address1 varchar(45),
	c_address2 varchar(45),
	c_address3 varchar(45),
	c_address4 varchar(45),
	b_address1 varchar(45),
	b_address2 varchar(45),
	b_address3 varchar(45),
	b_address4 varchar(45),	
...
(
	...
	susr1 varchar(30),
	shelflife int,
	allocatestrategykey varchar(10),
	preallocatestrategykey varchar(10),
	allocatestrategytype varchar(10),
	skurotation varchar(10),
...
begin
	...
	-- оптимизировано 13.11.2009 Полищук М.
	insert into #Orders (
	...
	select 'wh1', @orderkey, h.externorderkey, h.storerkey,
		...
		--
        insert into #OrderDetail (whseid, orderkey, 
				orderlinenumber, 
...
insert into wh1.orders 	
	(whseid, orderkey, externorderkey, storerkey, [type], susr1, susr2, susr3, susr4, consigneekey, 
	 c_company, c_city, c_contact1, c_contact2, b_city, b_contact1, b_contact2, b_company, c_address1,	
     c_address2,	c_address3,	c_address4, b_address1, b_address2, b_address3, b_address4, carriercode, 
	 requestedshipdate, transportationmode, door)
select * from #Orders

insert into wh1.orderdetail
	(whseid, orderkey,	orderlinenumber, externorderkey, storerkey,	sku, openqty, originalqty, unitprice, 
	 tax01, packkey, uom, susr1, shelflife,	allocatestrategykey, preallocatestrategykey, allocatestrategytype,
	 skurotation, product_weight, product_cube,cartongroup)
