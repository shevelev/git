...
*/
ALTER PROCEDURE [rep].[mof_Readiness_of_routes]
...
begin
	...
	from dbo.sub_udf_get_routes_between_dates(@date_from,@date_to,@routes) r
		...
		join wh2.ORDERS o with (NOLOCK,NOWAIT) on o.[ROUTE] = r.ROUTEID
	...
	from #ORDERS o
		...
		left join wh2.ORDERSTATUSHISTORY sh with (NOLOCK,NOWAIT) on sh.ORDERKEY = o.ORDERKEY and sh.ORDERLINENUMBER = ''
	...
	--select * from wh2.ORDERSTATUSSETUP o
	--select * from wh2.ORDERSTATUSHISTORY o where o.ORDERKEY = '0000037129' and o.ORDERLINENUMBER = '' order by o.ADDDATE desc
