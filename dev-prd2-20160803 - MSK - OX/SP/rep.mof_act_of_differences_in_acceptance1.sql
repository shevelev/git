...
ALTER PROCEDURE [rep].[mof_act_of_differences_in_acceptance1] (
...
--	select @wh='WH40', @nomer = '0000000608'
	...
	select t.SUSR10 SUSR10, r.receiptkey as k,
		...
		from wh2.receipt as r
			left join wh2.receiptdetail as rd on r.receiptkey=rd.receiptkey
			left join wh2.storer as st on r.storerkey=st.storerkey
			left join wh2.sku as t on rd.storerkey=t.storerkey and rd.sku=t.sku
