...
ALTER PROCEDURE [rep].[mof_ShippedList] (
	@wh varchar(10),
	@key varchar(12),
...
--		@key varchar(12),
--		@IsWave int -- 0 - заказ, 1-волна
--	select @wh='wh2', @key='0000017350', @iswave=0
...
--#endregion
	...
	select orderkey into #ordersList from wh2.orders where 1=2
	if @iswave = 0
...
/*	
	-- подготовить таблицу PackLoadSend
...
select orderkey, externorderkey,orderdate, requestedshipdate, consigneekey, CarrierCode  into #orders from wh2.orders where 1=2
print 1
