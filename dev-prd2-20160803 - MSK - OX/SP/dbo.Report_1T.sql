...
'SELECT	CONVERT(datetime, CONVERT(varchar(10), ord.EDITDATE, 104), 104) AS EditDate,
		...
		(ISNULL(ConstST.COMPANY, '''') + '', »ÕÕ '' + ISNULL(ConstST.VAT, '''') + '', '' + ISNULL(ConstST.ADDRESS1, '''') + '' '' + ISNULL(ConstST.ADDRESS2, '''') + '' '' + ISNULL(ConstST.ADDRESS3, '''')
		...
		as razgruzka,
		(ISNULL(BcompanyST.COMPANY, '''') + '', »ÕÕ '' + ISNULL(BcompanyST.VAT, '''') + '', '' + ISNULL(BcompanyST.ADDRESS1, '''') + '' '' + ISNULL(BcompanyST.ADDRESS2, '''') + '' '' + ISNULL(BcompanyST.ADDRESS3, '''')
