ALTER PROCEDURE [dbo].[Report_1TF02_NOVEX] (
...
'SELECT	CONVERT(datetime, CONVERT(varchar(10), ord.EDITDATE, 104), 104) AS EditDate,
		...
		(ISNULL(ConstST.COMPANY, '''') + '', '' +ISNULL(ConstST.City,'''')+'',''+ ISNULL(ConstST.ADDRESS1, '''') + '' '' + ISNULL(ConstST.ADDRESS2, '''') + '' '' + ISNULL(ConstST.ADDRESS3, '''')
			+ '', '' + ISNULL(ConstST.PHONE1, '''') +'' '' + ISNULL(ConstST.PHONE2, '''') + '', '' + ISNULL(ConstST.FAX1, '''')) 
		AS CONSIGNEEKEY,
		(ISNULL(ord.C_City,'''')+'',''+ISNULL(ord.C_ADDRESS1, '''')) 
		as razgruzka,
		(ISNULL(BcompanyST.COMPANY, '''') + '', '' + ISNULL(BcompanyST.ADDRESS1, '''') + '' '' + ISNULL(BcompanyST.ADDRESS2, '''') + '' '' + ISNULL(BcompanyST.ADDRESS3, '''')
			+ '', '' + ISNULL(BcompanyST.PHONE1, '''') +'' '' + ISNULL(BcompanyST.PHONE2, '''') + '', '' + ISNULL(BcompanyST.FAX1, '''') + ISNULL(cast(BcompanyST.NOTES2 as varchar(max)),'''')) 
		AS BCOMPANY,		
		(ISNULL(st.COMPANY, '''') + '', ''+ISNULL(st.City,'''')+'','' + ISNULL(st.ADDRESS1, '''') 
