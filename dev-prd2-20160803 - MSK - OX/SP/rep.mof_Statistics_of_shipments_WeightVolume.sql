 ...
 */
ALTER PROCEDURE [rep].[mof_Statistics_of_shipments_WeightVolume]
...
begin
	...
	from wh2.ORDERS o
		join wh2.ORDERDETAIL od
			join wh2.SKU s
				left join wh2.CODELKUP cl on cl.CODE = s.FREIGHTCLASS and cl.LISTNAME = 'FREIGHTCLS' -- может быть левый текст
