ALTER PROCEDURE [rep].[mof_DetailASN] (
	@wh varchar(30),
...
/**** end For testing ****/
	...
	from wh2.receiptdetail rd
		join wh2.sku sku on sku.storerkey=rd.storerkey and sku.sku=rd.sku
		join wh2.storer st on rd.storerkey=st.storerkey
		join wh2.pack p on p.packkey=rd.packkey
