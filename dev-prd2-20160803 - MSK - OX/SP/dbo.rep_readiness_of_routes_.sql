...
*/
ALTER PROCEDURE dbo.rep_readiness_of_routes_
...
begin
	...
	select
		...
		datediff(mi,nullif(max(isnull(sh.ADDDATE,@max_datetime)),@max_datetime),o.PLAN_ROUTE_DATETIME) as ORDER_DEVIATION
	into #DEVIATIONS
	from #ORDERS o
