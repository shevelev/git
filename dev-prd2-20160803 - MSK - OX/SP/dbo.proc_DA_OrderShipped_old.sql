...
ALTER PROCEDURE [dbo].[proc_DA_OrderShipped_old](
	@wh varchar(10),
...
insert #result (storerkey, externorderkey, [type], susr1, susr2, susr3, susr4, consigneekey, b_company, carriercode, sku, shippedqty)
	select o.storerkey, o.externorderkey, o.[type], o.susr1, o.susr2, o.susr3, o.susr4, o.consigneekey, o.b_company, o.carriercode, d.sku, p.qty
