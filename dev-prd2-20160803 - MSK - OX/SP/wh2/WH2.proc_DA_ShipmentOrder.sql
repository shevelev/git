						...
						BEGIN
							...
							--BEGIN
								...
								--BEGIN
									...
									from	[spb-sql1201].[DAX2009_1].[dbo].SZ_ImpOutputUpdateOrders
									
									insert into [spb-sql1201].[DAX2009_1].[dbo].SZ_ImpOutputUpdateOrders
									...
									--BEGIN
										...
										select	@maxid = max(cast(recid as int)) 
										from	[spb-sql1201].[DAX2009_1].[dbo].SZ_ImpOutputUpdOrderlines
										
										insert into [spb-sql1201].[DAX2009_1].[dbo].SZ_ImpOutputUpdOrderlines
...
begin
	...
	begin
		...
		from	[spb-sql1201].[DAX2009_1].[dbo].SZ_ExpOutputOrderLinesToWMS s
		...
		set	status = '15',
			error = @msg_errdetails
		from	[spb-sql1201].[DAX2009_1].[dbo].SZ_ExpOutputOrdersToWMS s
			join #DA_ShipmentOrderHead d
				on d.externorderkey = s.DocId				
		where	s.status = '5'
