...
-- =============================================
ALTER PROCEDURE [WH2].[PutawayStrategyCopy]
...
BEGIN
	...
	BEGIN 
	 insert into WH2.PUTAWAYSTRATEGY 
	(whseid, 
	putawaystrategykey,
	descr,
	adddate,
	...
	editdate,
	editwho 
	from WH2.PUTAWAYSTRATEGY
	where PUTAWAYSTRATEGYKEY=@TEMPLATESTRATEGY

insert into  WH2.PUTAWAYSTRATEGYdetail
(
WHSEID,
PUTAWAYSTRATEGYKEY,
...
EDITDATE,
EDITWHO
from WH2.PUTAWAYSTRATEGYdetail
where PUTAWAYSTRATEGYKEY=@TEMPLATESTRATEGY
