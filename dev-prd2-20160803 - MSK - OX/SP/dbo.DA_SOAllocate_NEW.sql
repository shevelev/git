...
ALTER PROCEDURE [dbo].[DA_SOAllocate_New] --(
	--@wh varchar(10)	= NULL
...
--		end -- while (@doNext and exists......
	...
	select	orderlinenumber, o.orderkey, o.sku, o.storerkey, ORIGINALQTY, --o.PACKKEY,
		o.lottable01, 
		o.LOTTABLE02,o.LOTTABLE06,o2.SUSR1 --LOTTABLE03, LOTTABLE04, LOTTABLE05, LOTTABLE06, 
	...
	if exists (select 1 from #orderdetail where susr1 <> '1')
	begin
	...
	begin
		...
		group by lli.sku, lli.loc, l.LOCATIONTYPE, la.LOTTABLE01, 
			la.LOTTABLE02,lli.id, --la.LOTTABLE03, la.LOTTABLE04, la.LOTTABLE05,
							od.LOTTABLE06--,
