ALTER PROCEDURE [dbo].[rep19_DetailASN] (
	@wh varchar(30),
...
/**** end For testing ****/
	...
	from '+@WH+'.receiptdetail rd
		join '+@WH+'.sku sku on sku.storerkey=rd.storerkey and sku.sku=rd.sku
		join '+@WH+'.storer st on rd.storerkey=st.storerkey
		join '+@WH+'.pack p on p.packkey=rd.packkey
