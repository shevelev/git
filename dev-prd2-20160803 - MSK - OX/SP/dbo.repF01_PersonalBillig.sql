ALTER PROCEDURE [dbo].[repF01_PersonalBillig] ( /*** =20091101 freez= Учет работы персонала склада 
...
from wh1.orders ord
	left join wh1.orderdetail od on ord.orderkey=od.orderkey
	left join wh1.sku sk on od.sku=sk.sku and ord.storerkey=sk.storerkey
	left join wh1.tariffdetail td on sk.busr3=td.descrip or sk.busr2=td.descrip or sk.busr1=td.descrip
	join wh1.taskdetail tskD on ord.orderkey=tskd.orderkey and od.sku=tskd.sku and ord.storerkey=tskd.storerkey and tskd.status=9
