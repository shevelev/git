...
ALTER PROCEDURE [rep].[Calculation_of_volume_and_weight] (
	@sd datetime = NULL,
...
from wh1.ORDERS o
	...
	join wh1.STORER s on s.STORERKEY = o.CONSIGNEEKEY
	join wh1.ORDERDETAIL od
		left join wh1.PICKDETAIL pd
			left join wh1.PICKCONTROL_LABEL pl on pl.CASEID = pd.CASEID
		...
		join wh1.SKU sku on sku.SKU = od.sku
	on od.ORDERKEY = o.ORDERKEY
	join wh1.LOADORDERDETAIL lod
		join wh1.LOADSTOP ls
			join wh1.LOADHDR lh on lh.LOADID = ls.LOADID
