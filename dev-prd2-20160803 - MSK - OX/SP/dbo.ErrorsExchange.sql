...
insert into #Journal
SELECT 19, 'Справочник товаров DAX -> INFOR' UNION
SELECT 1, 'Обновление карточки товара INFOR -> DAX' UNION
SELECT 2, 'Клиенты DAX -> INFOR' UNION
SELECT 3, 'Приемка DAX -> INFOR Шапка' UNION
SELECT 4, 'Приемка DAX -> INFOR Детали' UNION
SELECT 5, 'Приемка INFOR -> DAX Шапка' UNION
SELECT 6, 'Приемка INFOR -> DAX Детали' UNION
SELECT 7, 'Отгрузка DAX -> INFOR Шапка' UNION
SELECT 8, 'Отгрузка DAX -> INFOR Детали' UNION
SELECT 9, 'Комплектация INFOR -> DAX' Шапка UNION
SELECT 10, 'Комплектация INFOR -> DAX Детали' UNION
SELECT 11, 'Отгрузка INFOR -> DAX Шапка' UNION
SELECT 12, 'Отгрузка INFOR -> DAX Детали' UNION
SELECT 13, 'Отмена Отгрузки INFOR -> DAX Шапка' UNION
SELECT 14, 'Отмена Отгрузки INFOR -> DAX Детали' UNION
SELECT 15, 'Трансферты INFOR -> DAX Шапка' UNION
SELECT 16, 'Трансферты INFOR -> DAX Детали' UNION
SELECT 17, 'Трансферты DAX -> INFOR Шапка' UNION
SELECT 18, 'Трансферты DAX -> INFOR Детали' UNION
SELECT 20, 'Инвентаризация INFOR -> DAX'
