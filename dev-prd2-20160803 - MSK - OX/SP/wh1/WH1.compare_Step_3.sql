...
-- =============================================
-- Шаг 3: if @iP = 1 and @iD > 1 
-- одна запись ко многим п.3 
-- =============================================
...
--=======================================================================================================================================
	--print '3: if @iP = 1 and @iD > 1-- одна запись ко многим п.3'
...
-- не надо			select @QTY_D = @QTY_P - @QTY_D
--print 'перед записью'			
--print '@QTY_P = ' + convert(varchar(30),@QTY_P) + '@QTY_D = ' + convert(varchar(30),@QTY_D)
...
--==================================================================================================================
  ...
  END
CLOSE curCURSORstp3
DEALLOCATE curCURSORstp3 -- удалить из памяти  	
--=======================================================================================================================================
END
