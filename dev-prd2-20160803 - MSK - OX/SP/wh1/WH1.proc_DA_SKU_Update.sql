...
ALTER PROCEDURE [WH1].[proc_DA_SKU_Update]
	@wh varchar(10),
...
from	[spb-sql1201].[DAX2009_1].[dbo].SZ_ImpItemgrossparameters

    	
insert into [spb-sql1201].[DAX2009_1].[dbo].SZ_ImpItemgrossparameters
