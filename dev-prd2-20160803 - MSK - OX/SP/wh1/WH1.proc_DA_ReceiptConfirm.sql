...
--end	    
    ...
    from    [spb-sql1201].[DAX2009_1].[dbo].SZ_ImpInputOrdersFromWMS


    insert into [spb-sql1201].[DAX2009_1].[dbo].SZ_ImpInputOrdersFromWMS
    ...
    select  @n = isnull(max(cast(cast(recid as numeric) as bigint)),0)
    from    [spb-sql1201].[DAX2009_1].[dbo].SZ_ImpInputOrderLinesFromWMS
...
print 'Пытаемся вставить в обменные таблы DAX - после апдейта'
    ...
    insert into [spb-sql1201].[DAX2009_1].[dbo].SZ_ImpInputOrderLinesFromWMS
