...
ALTER PROCEDURE [WH1].[proc_DA_OrderShippedda](
	@wh varchar(10),
...
begin
	...
	from	[spb-sql1201].[DAX2009_1].[dbo].SZ_ImpOutputOrdersShip	
	
	insert into [spb-sql1201].[DAX2009_1].[dbo].SZ_ImpOutputOrdersShip
	...
	begin
		...
		select	@n = isnull(max(cast(cast(recid as numeric) as bigint)),0)
		from	[spb-sql1201].[DAX2009_1].[dbo].SZ_ImpOutputOrderlineShip
	
	
		insert into [spb-sql1201].[DAX2009_1].[dbo].SZ_ImpOutputOrderlineShip
