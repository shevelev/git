...
--END
	...
	values ('SP_CHECKORDERMANAGEMENT_CST0027','входные данные: ' + @wms_userid + ', '+@wh+ ', ' + @orderkey)
	...
	insert into DA_InboundErrorsLog (source,msg_errdetails) 
	values ('SP_CHECKORDERMANAGEMENT_CST0027','выходные данные: '+convert(varchar(10),@retcode))
