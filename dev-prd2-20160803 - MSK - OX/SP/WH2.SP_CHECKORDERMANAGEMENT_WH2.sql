ALTER PROCEDURE [WH2].[SP_CHECKORDERMANAGEMENT_WH2] 
--@wh        varchar(10),
@orderkey  varchar(18)
AS
BEGIN
...
insert into #case
	...
	from wh2.PICKDETAIL where ORDERKEY = @orderkey
...
update C set c.status = 
	...
	from #case c left join wh2.pickcontrol p on c.caseid = p.caseid
