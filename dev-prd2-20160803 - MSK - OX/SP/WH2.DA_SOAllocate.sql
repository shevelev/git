...
ALTER PROCEDURE [WH2].[DA_SOAllocate] --(
	--@wh varchar(10)	= NULL
...
--		end -- while (@doNext and exists......
	...
	if exists (select 1 from #orderdetail where susr1 not in ('СкладПродаж','СД'))
	begin
	...
	--print 'общее свободное количество товара на остатках склада штуки.'		
			...
			begin
				...
				begin
					...
					insert into dbo.SOAllocateLog (orderkey, susr5) values (@orderkey, @status_repl)
