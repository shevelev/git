ALTER PROCEDURE [dbo].[rep35_CommodityHolded_new](
...
select s.descr, pu.usr_name, i.fromloc,i.fromid, i.toloc, i.toid, i.qty, i.editdate 
into #restab
...
(i.toloc = ''LOST'' 
or i.toloc = ''BRAK''
or i.toloc = ''BRAKPRIEM''
or i.toloc = ''NETSTRATEG''
or i.toloc = ''NEIZVESTNO'')
and i.qty > 0
order by i.editdate'
