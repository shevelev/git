ALTER PROCEDURE [rep].[rep_shows_st_of_cases] (
	@dat1 datetime,
	@dat2 datetime,
	@zad int,
	@mar varchar(12),
...
join wh1.storer st on st.STORERKEY=o.b_company
join wh1.CODELKUP ck on ck.CODE=pd.STATUS and ck.LISTNAME=''ordrstatus''
join wh1.SKU s on s.SKU=pd.sku
join wh1.LOTATTRIBUTE la on la.LOT=pd.lot
join wh1.orderdetail od on od.orderkey=pd.ORDERKEY and od.ORDERLINENUMBER=pd.ORDERLINENUMBER
