...
/*
	...
	Модификация: 17.06.2015 -- Группировка итога
*/
CREATE TABLE [#rt](
	[SKU] [nvarchar](50) COLLATE Cyrillic_General_CI_AS NULL,
	[SKUGROUP] [nvarchar](20) COLLATE Cyrillic_General_CI_AS NULL,	
	[DESCR] [nvarchar](400) COLLATE Cyrillic_General_CI_AS NULL, --Описание товара
	[EXTN] [nvarchar](20) COLLATE Cyrillic_General_CI_AS NULL,
	...
	[dat] [nvarchar](150) COLLATE Cyrillic_General_CI_AS NULL,				
...
if @td>=0
	begin
		...
		--left join wh1.LOTATTRIBUTE la on la.SKU=pr.sku and la.LOTTABLE06=pr.LOTTABLE06
...
if (select COUNT(*) from #prinBRLO where st=10) >0
	begin
		...
		from #rt pr
		join #prinBRLO brlo on pr.SKU=brlo.SKU and pr.LOTTABLE02=brlo.LOTTABLE02 and pr.LOTTABLE05=brlo.LOTTABLE05 and pr.LOTTABLE04=brlo.LOTTABLE04 and pr.LOTTABLE06=brlo.LOTTABLE06 
		where brlo.susr4 in ('OVERPRIEM','PRETENZ') and brlo.st=10
...
select SKU, SKUGROUP, DESCR, EXTN, POKEY, CompanyName, LOTTABLE01, LOTTABLE02, LOTTABLE04,LOTTABLE05,LOTTABLE06, EFFECTIVEDATE, ud,FGr, nak, dat, busr2, SUM(zak) zak, SUM(otgr) otgr , SUM(brak) brak, SUM(lostpriem) lostpriem, SUM(overpriem) overpriem, editdate
from #rt
group by SKU, SKUGROUP, DESCR, EXTN, POKEY, CompanyName, LOTTABLE01, LOTTABLE02, LOTTABLE04,LOTTABLE05,LOTTABLE06, EFFECTIVEDATE, ud,FGr, nak, dat, busr2,editdate	
