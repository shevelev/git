ALTER PROCEDURE [dbo].[SZ_MVTask_NEW] 
AS
...
-- ATTENTION !!!
	...
	group by od.sku, od.storerkey,
		...
		--od.LOTTABLE01, 
		od.LOTTABLE02,od.LOTTABLE06, --od.LOTTABLE04, od.LOTTABLE05, od.LOTTABLE07, od.LOTTABLE08,
		o.TYPE, od.ORDERKEY
	...
	group by sku, storerkey, casecnt,
		od.LOTTABLE02,od.LOTTABLE06, --od.LOTTABLE03, od.LOTTABLE04, od.LOTTABLE05,lottable07,lottable08, 
		od.packkey 
	/* VC 26/08/2011 end */
...
--select * from #orderdetail where sku = '19117'
	...
	insert into #skuqty
		select 
			...
			od.LOTTABLE02, od.LOTTABLE06,--od.LOTTABLE03, od.LOTTABLE04, od.LOTTABLE05, od.LOTTABLE07, od.LOTTABLE08, 
			lli.lot, 
			lxl.ID, 
			l.LOGICALLOCATION 
		from #ORDERDETAIL od
