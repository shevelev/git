ALTER PROCEDURE [rep].[ Act_of_acceptance_ASN1] (
/* 01 Акт приемки (ПУО) */
	@wh varchar(30),
	@asn varchar(15),
	@nav varchar(15),
...
exec(@sql)
	...
	set @sql = 'select asn.*, bm.componentsku, asn.QTYEXPECTED*bm.qty compQTY, sk2.descr compname,
		...
		from #asn asn
			left join '+@wh+'.billofmaterial as bm on bm.sku = asn.sku and bm.storerkey = asn.storerkey
			...
			left join '+@wh+'.STORER st on asn.STORERKEY=st.STORERKEY
