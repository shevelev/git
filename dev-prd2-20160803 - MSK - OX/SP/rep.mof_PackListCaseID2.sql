...
ALTER PROCEDURE [rep].[mof_PackListCaseID2] (
...
left join wh2.storer st on st.storerkey = o.B_COMPANY
...
left join wh2.cartonization c on c.cartontype = pd.CARTONTYPE and  c.CARTONIZATIONGROUP=pd.CARTONGROUP
join wh2.LOTATTRIBUTE lat on pd.LOT=lat.lot
